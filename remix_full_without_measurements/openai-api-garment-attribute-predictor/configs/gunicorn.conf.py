...
# Worker processes - increased for true parallelism in I/O-bound OpenAI calls
# Attribute predictor does not load heavy local models → safe to scale workers/threads
workers = 4
